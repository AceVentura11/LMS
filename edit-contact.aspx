<%@ Page Language="C#" AutoEventWireup="true" CodeFile="edit-contact.aspx.cs" Inherits="edit_contact" %>
...
<%--<body class="hold-transition skin-blue sidebar-mini">--%>
            ...
            <aside class="main-sidebar" style="display:none;">
               ...
               <div class="content-wrapper" style="text-align:left;margin-left:165px;margin-right:165px">
                <section class="content-header">
                    <h1>Edit Contact</h1>
                   <%-- <ol class="breadcrumb">
                        <li><a href="list.aspx">Close</a></li>
                    </ol>--%>
                </section>
                            ...
                            <div class="box">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select runat="server" id="txt_clientname" class="form-control select2" style="width: 100%;">
                                        </select>
                                        <input style="margin-top:10px;" type="text" class="form-control optional" runat="server" id="new_client" autocomplete="off" />
                                        <input type="hidden" runat="server" id="contactid" />
                                    </div>
                                    <div class="form-group">
                                        <label>Office</label>
    ...
    <script>
        $().ready(function () {
            ...
            var array = $('#txt_clientcontact').val().split(",");
            $.each(array, function (i) {
                $('#ddl_clientcontact').val(array[i]).trigger('change');
            });
            ...
            $("#txt_clientname").change(function () {
                if ($('option:selected', this).val() == "New") {
                    ...
                    $("#new_client").val($("#txt_clientname").val());
                    $("#new_client").hide();
                }
            });
