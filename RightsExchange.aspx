<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RightsExchange.aspx.cs" Inherits="RightsExchange" %>
...
<%--<body class="hold-transition skin-blue sidebar-mini">--%>
                                ...
                                <div class="box-body">                                    
                                    <div class="form-group" >
                                        ...
                                        <div class="input-group">
                                             <select runat="server" id="ddlusername1" class="form-control select2 optional" style="width: 100%;"> <%--onchange="getclient1()"--%>
                                                 </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label>User Name:</label>
                                        <select runat="server" id="ddlusername2" class="form-control select2 optional" style="width: 100%;">
                                           
                                        </select>
                                        
                                    </div>
                                 <%--  <div class="box-footer text-right"> 
                                       <input type="button" value="Add"  id="btnadd" runat="server" style="background-color:#367fa9" />
                                   </div>--%>
                                    <div class="form-group">
                                        <%--<label>Gender :</label>
    ...
    <script src="assets/js/additional-methods.js"></script>
        <script>
            ...
            $.ajax({
                type: "POST",
                url: "RightsExchange.aspx/fillusername2",
                data: '{type: "' + $("#ddlusername1").val() + '" }',
