<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProposalStatusTracking.aspx.cs" Inherits="ProposalStatusTracking" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <h3 style="color:blue;font:bold">Proposal Status Update</h3>
        <h5 style="color:red;font:bold">Please update the status of the Proposal listed below</h5>
        ...
        <asp:GridView Style="margin-top: 0px;" EmptyDataText="No proposals found...." runat="server" ID="gv_list" AutoGenerateColumns="false" AllowPaging="true" PageSize="10" OnPageIndexChanging="gv_list_PageIndexChanging" CssClass="pure-table pure-table-bordered" OnRowDataBound="gv_list_RowDataBound">
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Status" HeaderStyle-ForeColor="Red">
                    <ItemTemplate>
                ...
                <asp:TemplateField HeaderText="Edit">
                    <ItemTemplate>
                        <asp:Button runat="server" ID="btn_proposal" Text="Edit" OnCommand="btn_proposal_Command" CssClass="button-secondary pure-button" CommandArgument='<%# Eval("LID") %>' CommandName='<%# Eval("CID") %>' />
                    </ItemTemplate>
                </asp:TemplateField>
