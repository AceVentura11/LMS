        ...
        <div class="login-box-body" style="background-color:#d2d6de;">
            ...
            <form id="form1" runat="server">
                <div class="form-group has-feedback">
                    <input type="text" class="form-control" placeholder="User Name" id="txt_uname" runat="server" autocomplete="off" />
                    <span class="glyphicon glyphicon-user form-control-feedback"></span>
                </div>
                <div class="form-group has-feedback">
                    <input type="password" class="form-control" placeholder="Password" id="txt_password" runat="server" autocomplete="off" />
                ...
                <div class="row">
                    ...
                    <div class="col-xs-4">
                        <asp:Button runat="server" ID="btn_submit" CssClass="btn btn-primary btn-block btn-flat" Text="Log in" OnClick="btn_submit_Click" />
                    </div>
                </div>
            </form>
